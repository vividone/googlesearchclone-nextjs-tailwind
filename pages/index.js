...
<header className="flex w-full p-5 justify-between text-sm text-gray-700">
    ...
    <Avatar url='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSob_RwxziqNH9cr5nJaIjZnJO8ZQBzvocERSz9XGTssUYUy15oy3bAVF6lmr5kaUsJp9Y&usqp=CAU' />
    </div>
</header>
{/* Body */}
    <form className="flex flex-col items-center flex-grow mt-44 w-4/5">
      <Image 
        ...
        width={300}
      />
      <div className="flex w-full mt-5 hover:shadow-lg focus-within:shadow-lg rounded-full border-2 border-gray-100 px-5 py-3 items-center sm:max-w-xl lg:max-w-2xl ">
        <SearchIcon className="ml-3 mr-3 h-5 text-gray-500"/>
        <input type="text" className="focus:outline-none flex-grow" ref={searchInputRef}/>
        <MicrophoneIcon className="mr-3 h-5 text-gray-500"/>
      </div>
